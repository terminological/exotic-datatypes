...
public class DelimitedParserBuilder {
	...
	//builder
	public Iterator<Deferred<List<String>,ParserException>> build(Reader in) {
		if (this.machine.equals(DelimitedParserMachine.IANA_TSV)) {
			return new SimpleIANAParser(in, seperator.get());
		} else {
	...
	public static Iterable<Deferred<List<String>,ParserException>> excelCsv(Reader in) {
		return new Iterable<Deferred<List<String>,ParserException>>() {
			public Iterator<Deferred<List<String>,ParserException>> iterator() {
				return machine(",","\"").lineEnding("\r\n").build(in);
			}
		};
	}

	public static Iterable<Deferred<List<String>,ParserException>> tsv(Reader in) {
		return new Iterable<Deferred<List<String>,ParserException>>() {
			public Iterator<Deferred<List<String>,ParserException>> iterator() {
	...
	public static Iterable<Deferred<List<String>,ParserException>> pipe(Reader in) {
		return new Iterable<Deferred<List<String>,ParserException>>() {
			public Iterator<Deferred<List<String>,ParserException>> iterator() {
				return machine("|").build(in);
			}
	...
	public static Iterable<Deferred<List<String>,ParserException>> mysql(Reader in) {
		return new Iterable<Deferred<List<String>,ParserException>>() {
			public Iterator<Deferred<List<String>,ParserException>> iterator() {
				return machine(",","\"","\\").build(in);
			}
