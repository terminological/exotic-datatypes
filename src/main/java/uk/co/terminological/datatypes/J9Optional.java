 ...
 * @since 1.8
 */
public final class J9Optional<T> {
    /**
     * Common instance for {@code empty()}.
     */
    private static final J9Optional<?> EMPTY = new J9Optional<>();
     ...
     *
     * @implNote Generally only one empty instance, {@link J9Optional#EMPTY},
     * should exist per VM.
     */
    private J9Optional() {
        this.value = null;
     ...
     */
    public static<T> J9Optional<T> empty() {
        @SuppressWarnings("unchecked")
        J9Optional<T> t = (J9Optional<T>) EMPTY;
        return t;
    }
     ...
     * @throws NullPointerException if value is {@code null}
     */
    public static <T> J9Optional<T> of(T value) {
        return new J9Optional<>(value);
    }
     ...
     */
    public static <T> J9Optional<T> ofNullable(T value) {
     ...
     */
    public J9Optional<T> filter(Predicate<? super T> predicate) {
     ...
     */
    public <U> J9Optional<U> map(Function<? super T, ? extends U> mapper) {
        Objects.requireNonNull(mapper);
        if (!isPresent()) {
            return empty();
        } else {
            return J9Optional.ofNullable(mapper.apply(value));
        }
    }
     ...
     */
    public <U> J9Optional<U> flatMap(Function<? super T, ? extends J9Optional<? extends U>> mapper) {
        Objects.requireNonNull(mapper);
        if (!isPresent()) {
            return empty();
        } else {
            @SuppressWarnings("unchecked")
            J9Optional<U> r = (J9Optional<U>) mapper.apply(value);
     ...
     * @since 9
     */
    public J9Optional<T> or(Supplier<? extends J9Optional<? extends T>> supplier) {
        Objects.requireNonNull(supplier);
        if (isPresent()) {
            return this;
        } else {
            @SuppressWarnings("unchecked")
            J9Optional<T> r = (J9Optional<T>) supplier.get();
            return Objects.requireNonNull(r);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof J9Optional)) {
            return false;
        }

        J9Optional<?> other = (J9Optional<?>) obj;
